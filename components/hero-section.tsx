...
// ✅ Corrected variants with proper typing and structure
const animatedVariants: Variants = {
  ...
  visible: {
    ...
    y: 0,
    transition: {
      type: 'spring' as const, // TypeScript-safe literal
      bounce: 0.3,
      damping: 20,
    },
  },
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                {/* Use your fixed variants here */}
                <AnimatedGroup variants={{ item: animatedVariants }}>
                  <Link
                    href="#link"
